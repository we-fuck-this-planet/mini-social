          ...
          <div class="content-bottom">
            <ul class="friends__type">
              <li class="friends__type-list">
                <router-link to="/friends/search" class="item"
                  >Поиск</router-link
                >
              </li>
              <li class="friends__type-list">
            ...
            <!-- <p class="friends-notify">К сожалению, у тебя пока нет подписчиков</p> -->

            <div class="user__list" v-for="info in user" v-bind:key="info._id">
              <div class="user">
                ...
                <div class="user__info">
                  <div>
                    ...
                    >
                      <p class="user-login">@{{ info.username }}</p>
                    </router-link>
                  </div>
  ...
  methods: {
    ...
    getAllUsers() {
      return axios.get("/api/users").then((response) => {
        response.data.map((data) => this.user.push(data));
      });
    },
  },
  mounted() {
